        ...
        <div className={styles.message}>
          ...
          <Fade direction="up" duration={900} delay={1800}>
            <div>
              ...
              <a className={styles.resumeButton} target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1MJ8GeGwLb-0uwPI5lpLQwQM1ilE39goE/view?usp=sharing">Resume</a>
            </div>
          </Fade>
        </div >
      </div>
